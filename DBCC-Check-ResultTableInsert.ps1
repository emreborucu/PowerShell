...
$db_name.ForEach{
    ...
    $result | Add-Member -NotePropertyName "DBName" -NotePropertyValue $_
    $result | Add-Member -NotePropertyName "LogDate" -NotePropertyValue (Get-Date)
    $result | Write-DbaDataTable -SqlInstance "LCWSUNYONGENDB" -Database "SunucuYonetimGenel" -Table "DBCC_ConsistencyCheck" -AutoCreateTable
